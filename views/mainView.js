    ...
    updating: {
        ...
        updateResources: function() {
            if(prevState.mana !== mana || prevState.maxMana !== maxMana) {
                ...
                document.getElementById("manaTooltip").innerHTML = "法力.<br>Start with " + intToString(levelData.initial.mana, 1) + "<br>Current max is " + intToString(maxMana, 1);
            }
        ...
        updateKingTab: function() {
            ...
            if(updateRapportGain) {
                ...
                allDivs += "当前奖励: <b>" + round((rapportBonus-1)*100) + "</b>%";
                    ...
                    if (actionData.list.hasOwnProperty(property)) {
                        ...
                        actionDatum.forEach(function(action) {
                            ...
                            infoText += '<div id="'+action.varName+'InfoBox" class="infoBox '+backgroundColor+'">' +
                                '<div class="smallTitle">'+cnItem(action.name)+'</div>' +
                                tributeInfo +
